...
import logbook.swing.scroll.ScrollBar;
import javax.swing.JLabel;
import javax.swing.JPanel;
import javax.swing.JScrollPane;
import javax.swing.border.EmptyBorder;
import logbook.main.Main;
...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("Data Visitor");
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DONE_ALL, "Approval Section"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_IDENTITY, "List Data Visitor"));
        
        addTitle("Data Karyawan");
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.GROUP_ADD, "Data Karyawan"));
         
        addTitle("Data Mitra");
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.WORK, "Data Mitra"));
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DEVICES_OTHER, "List Device Mitra"));
         
        addTitle("Laporan");
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PRINT, "Laporan"));
       
        addTitle("");
        addTitle("");
        //addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.CANCEL, "Logout"));
      
        final JButton b = new JButton("Logout");
        panelMenu.add(b);
