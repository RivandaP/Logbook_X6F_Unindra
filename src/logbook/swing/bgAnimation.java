...
public class bgAnimation extends JPanel {
    ...
    public void paint(Graphics grphcs) {
        ...
        g2.setColor(new Color(255, 220, 239));
        g2.fill(createShape(height, 10, 30, 10, 60));
        g2.setColor(new Color(255, 199, 199));
        g2.fill(createShape(height, 40, 10, 60, 10, 60, 10));
        g2.setColor(new Color(255, 154, 154));
        g2.fill(createShape(height, 30, 1, 20, 1, 30));
